...
$code = $_POST['code'];
$result = mysqli_query($con,"SELECT * FROM `productsc4` WHERE `code`='$code'");
...
<head>
<title>CART</title>
<link rel='stylesheet' href='stylec4.css' type='text/css' media='all' />
<style type="text/css">
	.back{
...
<body style="background-image: linear-gradient(-90deg, blue, aqua);">
	<a href="https://attirent.000webhostapp.com/weddingmen.html" class="back" >BACK TO WEDDING MEN PAGE</a>
...
?>
<div class="cart_div">
<a href="cartc4.php"><img src="cart-icon.png" /> Cart<span><?php echo $cart_count; ?></span></a>
</div>

<?php
}

$result = mysqli_query($con,"SELECT * FROM `productsc4`");
