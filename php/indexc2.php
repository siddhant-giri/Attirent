...
$code = $_POST['code'];
$result = mysqli_query($con,"SELECT * FROM `productsc2` WHERE `code`='$code'");
...
<a href="https://attirent.000webhostapp.com/weddingwomen.html" class="back" >BACK TO WEDDING WOMEN PAGE</a>
...
?>
<div class="cart_div">
<a href="cartc2.php"><img src="cart-icon.png" /> Cart<span><?php echo $cart_count; ?></span></a>
</div>
<?php
}

$result = mysqli_query($con,"SELECT * FROM `productsc2`");
